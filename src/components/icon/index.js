...
const MessageIcon = ({ width = '2.9rem', height = '2.9rem', className }) => (
    <svg
        class={className}
        width={width}
        data-e2e=""
...
const NotificationIcon = ({ width = '3.2rem', height = '3.2rem', className }) => (
    <svg
        className={className}
        width={width}
        height={height}
...
const SearchIcon = ({ width = '2.7rem', height = '2.7rem', className }) => (
    <svg
        width={width}
        data-e2e=""
        height={height}
...
export { UploadIcon, MessageIcon, NotificationIcon, SearchIcon };
